...
class QuestionnaireDAnnulationTest extends TestCase
{
    ...
    /** « Le travail ne correspond pas » renvoie vers le nouveau devis — qui n'existe que sur le moteur à domicile. */
    ...
    /** Une exemption qui n'a PAS été appliquée ne compte pas contre la personne — sinon le premier dépassement en produirait un second, puis un troisième, sans qu'elle ait rien obtenu. */
