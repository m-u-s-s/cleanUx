...
class WireConfirmPasseParLaModaleTest extends TestCase
{
     ...
     *
     * Sur cinquante-neuf, quarante-cinq suppriment, retirent, suspendent ou annulent. Une modale
     ...
     *
     * Aucun des cinquante-neuf ne le fait aujourd'hui. Ce test le maintient.
     */
...
', $coupables));
     ...
     *
     * « Aucune page invitee ne porte wire:confirm » et le compte de cinquante-neuf vivaient en
    ...
    public function test_les_deux_affirmations_de_ce_fichier_sont_mesurees(): void
    {
        ...
        $this->assertSame(
            59,
            $confirmations,
            "Le compte de `wire:confirm` a change : ce fichier en annonce cinquante-neuf.\n"
