...
class WireConfirmPasseParLaModaleTest extends TestCase
{
     ...
     *
     * Sur cinquante et un, trente-neuf suppriment, retirent, suspendent ou annulent. Une modale
     ...
     *
     * Aucun des cinquante et un ne le fait aujourd'hui. Ce test le maintient.
     */
...
', $coupables));
     ...
     *
     * « Aucune page invitee ne porte wire:confirm » et le compte de cinquante et un vivaient en
    ...
    public function test_les_deux_affirmations_de_ce_fichier_sont_mesurees(): void
    {
        ...
        $this->assertSame(
            51,
            $confirmations,
            "Le compte de `wire:confirm` a change : ce fichier en annonce cinquante et un.\n"
