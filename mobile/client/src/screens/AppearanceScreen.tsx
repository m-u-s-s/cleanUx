...
const OPTIONS = [
  { mode: 'system' as const, label: 'appearance.automatique', description: 'appearance.suit_le_reglage_du_systeme' },
  { mode: 'light' as const, label: 'appearance.clair', description: 'appearance.toujours_en_mode_clair' },
  { mode: 'dark' as const, label: 'appearance.sombre', description: 'appearance.toujours_en_mode_sombre' },
];
