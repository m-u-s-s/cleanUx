 ...
 * d'ouvrir un module, chaque application ayant son propre hôte embarqué. Le catalogue vient du
 * serveur, qui déduit le contexte du jeton — cet écran n'a donc rien à conditionner.
 */
