/**
 * L'application cliente se DÉCLARE au serveur.
 *
...
describe('Déclaration de l’application cliente', () => {
  ...
  it('se déclare comme application CLIENTE', () => {
    expect(source).toMatch(/setAppAudience\(\s*'client'\s*\)/);
  });
