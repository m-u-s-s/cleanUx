 ...
 *   VAPID_PRIVATE_KEY=...
 *
 * Note : les clés doivent rester STABLES une fois en prod ; ne pas régénérer
...
class GenerateVapidKeysCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $this->line('');
        $this->warn('⚠ Une fois en prod, NE JAMAIS régénérer ces clés : toutes les');
        $this->warn('  subscriptions de tes utilisateurs deviendraient invalides.');
