...
Route::middleware(['auth:sanctum', 'active.account'])->prefix('client')->group(function () {
...
*/
Route::middleware(['auth:sanctum', 'active.account'])->prefix('client/company')->group(function () {
...
*/
Route::middleware(['auth:sanctum', 'active.account'])->prefix('client/quotes')->group(function () {
...
*/
Route::middleware(['auth:sanctum', 'active.account'])->prefix('client/places')->group(function () {
...
// ─────────────────────────────────────────────
Route::middleware(['auth:sanctum', 'active.account'])->get('/parity-map', ParityMapController::class)->name('api.parity-map');
