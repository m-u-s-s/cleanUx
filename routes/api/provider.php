...
*/
Route::middleware(['auth:sanctum', 'verified', 'role:employe'])->prefix('provider/growth')->group(function () {
...
Route::middleware(['auth:sanctum', 'verified'])->prefix('provider/safety')->group(function () {
...
Route::middleware(['auth:sanctum', 'verified', 'role:employe', 'provider.approved', 'face.verified'])->group(function () {
...
Route::middleware(['auth:sanctum', 'verified', 'token.grace'])->prefix('provider')->group(function () {
...
*/
Route::middleware(['auth:sanctum', 'verified'])->prefix('provider')->group(function () {
 ...
 */
Route::middleware(['auth:sanctum', 'verified', 'role:admin', 'enforce_2fa'])->group(function () {
...
*/
Route::middleware(['auth:sanctum', 'verified', 'org.type:provider'])->prefix('provider/company')->group(function () {
    /*
