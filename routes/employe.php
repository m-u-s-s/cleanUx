...
Route::middleware(['role:employe', 'provider.approved', 'espace.fusionne'])
...
|
| Voir `routes/client.php` : meme corps, meme raison. Le prefixe `moi` evite les trois
| collisions d'URI avec l'espace societe (`equipe`, `planning`, `modules`).
*/
Route::middleware(['role:employe', 'provider.approved', 'org.type:provider'])
    ->prefix('dashboard/entreprise-prestataire/moi')
    ->name('provider-company.perso.')
