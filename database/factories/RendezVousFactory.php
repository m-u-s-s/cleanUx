...
class RendezVousFactory extends Factory
{
    ...
    {
        return $this
            ->afterMaking(function (RendezVous $rendezVous): void {
                $this->synchronizeStructuredContext($rendezVous);
            })
            ->afterCreating(function (RendezVous $rendezVous): void {
    ...
    protected function synchronizeStructuredContext(RendezVous $rendezVous, bool $persist = false): void
    {
