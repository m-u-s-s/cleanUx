...
@php
    ...
    $config = match($normalized) {
        ...
        // LES ETATS D UN ENVOI. Sans eux le repli imprimait « Queued », « Sent », « Bounced »
        // — la valeur brute du prestataire, en anglais, dans un tableau de bord francais.
        'queued' => ['classes' => 'bg-slate-100 text-slate-600 border-slate-200', 'label' => 'En file'],
        'sent' => ['classes' => 'bg-blue-100 text-blue-700 border-blue-200', 'label' => 'Parti'],
        'delivered' => ['classes' => 'bg-emerald-100 text-emerald-700 border-emerald-200', 'label' => 'Remis'],
        'bounced' => ['classes' => 'bg-red-100 text-red-700 border-red-200', 'label' => 'Rejeté'],
        'failed' => ['classes' => 'bg-red-100 text-red-700 border-red-200', 'label' => 'Échec'],
