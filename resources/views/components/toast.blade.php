...
>
    <div
        class="min-w-[300px] max-w-sm overflow-hidden rounded-[22px] border px-4 py-3 text-sm font-medium shadow-[0_22px_55px_rgb(var(--brio-ink-rgb)/0.18)] backdrop-blur brio-scale-in"
        :class="{
