{{-- `.brio-stat-grid` s'adapte au nombre de cases plutot que de fixer deux colonnes :
     sous 390px, six cases sur deux colonnes font trois rangees hautes. --}}
<section class="brio-stat-grid">
    ...
    <x-ui.stat title="Progression" :value="$statsJour['progression']" unit="%" tone="emerald" heroicon="arrow-trending-up" hint="Avancement" />
</section>
