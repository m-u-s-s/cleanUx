<div class="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm transition hover:border-sky-200 hover:shadow-md">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        ...
        <div class="flex flex-col items-start gap-3 lg:items-end">
            ...
            <a href="{{ \Illuminate\Support\Facades\URL::temporarySignedRoute('client.finance.quote.download', now()->addMinutes(config('finance.download_url_ttl_minutes', 30)), $quote) }}" class="brio-btn-secondary">
                📥 Télécharger
            </a>
        </div>
    </div>
