    ...
    <div class="bg-gradient-to-r from-blue-700 via-indigo-700 to-slate-900 px-6 py-7 text-white">
        <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('admin.planning') }}" class="rounded-xl bg-white px-4 py-2 text-sm font-bold text-blue-700 shadow-sm hover:bg-blue-50">
                    🗓️ Planning
                </a>

                <a href="{{ route('admin.missions') }}" class="rounded-xl bg-white/10 px-4 py-2 text-sm font-bold text-white ring-1 ring-white/30 hover:bg-white/20">
                    📋 Missions
                </a>

                <a href="{{ route('admin.premium.clients') }}" class="rounded-xl bg-amber-400 px-4 py-2 text-sm font-bold text-slate-900 shadow-sm hover:bg-amber-300">
                    ★ Premium
                </a>

                <a href="{{ route('admin.outils') }}" class="rounded-xl bg-white/10 px-4 py-2 text-sm font-bold text-white ring-1 ring-white/30 hover:bg-white/20">
                    🛠️ Outils
                </a>
            </div>
        </div>
