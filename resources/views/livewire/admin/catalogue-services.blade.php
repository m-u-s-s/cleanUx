<div class="cu-page">
    ...
    <div class="grid grid-cols-1 gap-6 xl:grid-cols-3">
        ...
        <div class="xl:col-span-2 space-y-6">
            ...
            <div wire:loading.delay.short wire:target="search,status,market,serviceType,selectService,toggleActive" class="cu-loading-panel space-y-3">
            ...
            <div wire:loading.remove wire:target="search,status,market,serviceType,selectService,toggleActive">
