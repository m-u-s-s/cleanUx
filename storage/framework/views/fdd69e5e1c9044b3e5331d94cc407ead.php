                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ms-3">
                            <div class="text-sm text-gray-600">
                                <?php echo e($session->agent->platform() ? $session->agent->platform() : 'Inconnu'); ?> - <?php echo e($session->agent->browser() ? $session->agent->browser() : 'Inconnu'); ?>
                            ...
                            <div class="text-xs text-gray-500">
                                ...
                                <?php else: ?>
                                    Dernière activité <?php echo e($session->last_active); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['type' => 'password','class' => 'mt-1 block w-3/4','autocomplete' => 'current-password','placeholder' => 'Mot de passe','xRef' => 'password','wire:model' => 'password','wire:keydown.enter' => 'logoutOtherBrowserSessions']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'password','class' => 'mt-1 block w-3/4','autocomplete' => 'current-password','placeholder' => 'Mot de passe','x-ref' => 'password','wire:model' => 'password','wire:keydown.enter' => 'logoutOtherBrowserSessions']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\Users\mmdar\Desktop\code\work\CleanUx\resources\views/profile/logout-other-browser-sessions-form.blade.php ENDPATH**/ ?>