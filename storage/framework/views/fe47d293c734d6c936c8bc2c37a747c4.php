    ...
    <div class="rounded-2xl border bg-white p-6 shadow-sm space-y-4 max-w-3xl">
        <div class="grid gap-4 md:grid-cols-2">
            <select wire:model="rendezVousId" class="rounded-xl border-gray-300 text-sm">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->rendezVousOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rdv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($rdv->id); ?>"><?php echo e($rdv->booking_reference); ?> — <?php echo e($rdv->date?->format('d/m/Y')); ?> — <?php echo e($rdv->client?->name); ?></option>
...
<?php /**PATH C:\Users\mmdar\Desktop\code\work\CleanUx\resources\views/livewire/employe/signaler-incident.blade.php ENDPATH**/ ?>