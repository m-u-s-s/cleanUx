...
return [
    'modules' => [
         ...
         *
         * `responsive_verified` à false, faute d'avoir vérifié le rendu à 390 px : l'écran est
         * scindé en deux colonnes sur grand écran et je ne l'ai pas regardé empilé.
         */
        ['key' => 'admin-order-engine', 'title' => 'Catalogue de commande', 'icon' => 'sparkles-outline', 'path' => '/admin/catalogue', 'web' => 'native', 'mobile' => 'webview', 'roles' => ['admin'], 'responsive_verified' => false],
        ...
        ['key' => 'admin-matching', 'title' => 'Matching', 'icon' => 'apps-outline', 'path' => '/admin/matching', 'web' => 'native', 'mobile' => 'webview', 'roles' => ['admin'], 'responsive_verified' => true],
        ...
        ['key' => 'admin-ia-dispatch', 'title' => 'Dispatch IA', 'icon' => 'apps-outline', 'path' => '/admin/ia-dispatch', 'web' => 'native', 'mobile' => 'webview', 'roles' => ['admin'], 'responsive_verified' => true],
        ...
        ['key' => 'dashboard-client-profil', 'title' => 'Profil', 'icon' => 'apps-outline', 'path' => '/dashboard/client/profil', 'web' => 'native', 'mobile' => 'webview', 'roles' => ['client'], 'responsive_verified' => true],
        ['key' => 'dashboard-client-favoris-employes', 'title' => 'Favoris employés', 'icon' => 'apps-outline', 'path' => '/dashboard/client/favoris-employes', 'web' => 'native', 'mobile' => 'webview', 'roles' => ['client'], 'responsive_verified' => true],
        ...
        ['key' => 'dashboard-client-abonnements', 'title' => 'Abonnements', 'icon' => 'apps-outline', 'path' => '/dashboard/client/abonnements', 'web' => 'native', 'mobile' => 'webview', 'roles' => ['client'], 'responsive_verified' => true],
        ...
        ['key' => 'dashboard-client-analytics', 'title' => 'Analytics', 'icon' => 'apps-outline', 'path' => '/dashboard/client/analytics', 'web' => 'native', 'mobile' => 'webview', 'roles' => ['entreprise'], 'responsive_verified' => true],
