...
return [
    'modules' => [
        ...
        // LOCATION ENTRE MEMBRES — un membre loue et prete, quel que soit son role : les cinq
        ...
        ['key' => 'peer-sejours', 'title' => 'Louer un logement', 'icon' => 'home-outline', 'path' => '/sejours', 'web' => 'native', 'mobile' => 'webview', 'roles' => ['client', 'entreprise', 'provider', 'provider_company'], 'responsive_verified' => true],
        ['key' => 'peer-mes-logements', 'title' => 'Mes logements en location', 'icon' => 'business-outline', 'path' => '/dashboard/location-entre-membres/mes-logements', 'web' => 'native', 'mobile' => 'webview', 'roles' => ['client', 'entreprise', 'provider', 'provider_company'], 'responsive_verified' => true],
        ...
        ['key' => 'presence-me', 'title' => 'Ma présence', 'icon' => 'radio-outline', 'path' => '/presence/me', 'web' => 'native', 'mobile' => 'webview', 'roles' => ['provider', 'provider_company'], 'responsive_verified' => true],
