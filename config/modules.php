...
return [
    ...
    'catalogue' => [
        ...
        ['key' => 'admin:admin.international', 'label' => 'International', 'icon' => '🌍', 'route' => 'admin.international', 'context' => 'admin', 'category' => 'comptes', 'primary' => false, 'gate' => 'manage-international'],
        ['key' => 'admin:admin.onboarding.documents', 'label' => 'Documents onboarding', 'icon' => '📎', 'route' => 'admin.onboarding.documents', 'context' => 'admin', 'category' => 'comptes', 'primary' => false, 'gate' => 'manage-users'],
        ['key' => 'admin:admin.onboarding.providers', 'label' => 'Onboarding prestataires', 'icon' => '🚀', 'route' => 'admin.onboarding.providers', 'context' => 'admin', 'category' => 'comptes', 'primary' => false, 'gate' => 'manage-users'],
        ...
        ['key' => 'admin:admin.services', 'label' => 'Services', 'icon' => '🧽', 'route' => 'admin.services', 'context' => 'admin', 'category' => 'comptes', 'primary' => false, 'gate' => 'manage-services'],
        ...
        ['key' => 'admin:admin.zones', 'label' => 'Zones', 'icon' => '🗺️', 'route' => 'admin.zones', 'context' => 'admin', 'category' => 'comptes', 'primary' => false, 'gate' => 'manage-services'],
        ['key' => 'admin:admin.onboarding-v2.center', 'label' => 'Onboarding v2', 'icon' => '🚪', 'route' => 'admin.onboarding-v2.center', 'context' => 'admin', 'category' => 'prestataires', 'primary' => false, 'gate' => 'manage-users'],
        ['key' => 'admin:admin.providers.registrations', 'label' => 'Inscriptions prestataires', 'icon' => '🙋', 'route' => 'admin.providers.registrations', 'context' => 'admin', 'category' => 'prestataires', 'primary' => false, 'gate' => 'manage-users'],
        ...
        ['key' => 'admin:admin.kyc.center', 'label' => 'KYC providers', 'icon' => '🪪', 'route' => 'admin.kyc.center', 'context' => 'admin', 'category' => 'conformite', 'primary' => false, 'gate' => 'manage-compliance'],
        ...
        ['key' => 'admin:admin.trades', 'label' => 'Trades catalogue', 'icon' => '🛠️', 'route' => 'admin.trades', 'context' => 'admin', 'category' => 'plateforme', 'primary' => false, 'gate' => 'manage-services'],
        /*
