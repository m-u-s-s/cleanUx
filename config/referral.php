...
return [
    ...
    */
    'sharing' => [
        'message_template_fr' => 'Découvrez Brio ! Utilisez mon code {code} et obtenez 15€ de réduction sur votre premier service. {link}',
        'message_template_nl' => 'Ontdek Brio! Gebruik mijn code {code} en krijg 15€ korting op je eerste dienst. {link}',
        'message_template_en' => 'Discover Brio! Use my code {code} and get €15 off your first service. {link}',
    ],
