...
class PlatformSettlement extends Component
{
    ...
    /** Vide a l'initialisation, posee au montage : une propriete PHP ne peut pas appeler de fonction dans sa valeur par defaut, et `'eur'` en dur ferait creer des comptes de secours libelles en euros sur une plateforme qui n'y regle pas. */
