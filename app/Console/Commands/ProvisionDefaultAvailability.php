...
class ProvisionDefaultAvailability extends Command
{
    ...
    public function handle(DefaultAvailabilityProvisioner $provisioner): int
    {
        ...
        // Le filtre porte sur l'ABSENCE de créneau, pas sur une date d'inscription : c'est la seule formulation qui reste juste si la commande est rejouée, ou si un prestataire supprime tout et veut repartir du défaut.
        ...
        // Le garde-fou de la mesure : si le compte de départ et le compte d'arrivée divergent, c'est qu'un prestataire a été écarté silencieusement — un profil sans rôle `employe`, par exemple.
