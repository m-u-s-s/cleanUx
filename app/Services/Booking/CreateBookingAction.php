...
class CreateBookingAction
{
    ...
    public function execute(
        ...
        $rendezVous = Booking::create([
            ...
            'frequency' => Arr::get($data, 'frequency', Arr::get($data, 'frequence')),
            ...
            'contact_phone' => Arr::get($data, 'contact_phone', Arr::get($data, 'telephone_client')),
            'priorite' => Arr::get($data, 'priorite', 'normale'),
            'customer_comment' => Arr::get($data, 'customer_comment', Arr::get($data, 'commentaire_client')),
            ...
            'estimated_duration_minutes' => Arr::get($data, 'estimated_duration_minutes', Arr::get($data, 'duree_estimee')),
            'devis_estime' => $adjustedEstimate,
            'status' => $status,
