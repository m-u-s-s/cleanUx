...
class ProductEmailTemplates
{
    ...
    {
        // `forceFill()` PARCE QUE L'APERÇU A BESOIN D'UN IDENTIFIANT.
    ...
    public static function payload(string $key): array
    {
        ...
        return match ($key) {
            ...
            'finance_reminder' => [
                ...
                'action_url' => route('client.finance'),
            ...
            'new_booking_admin' => [
                ...
                'action_url' => route('admin.planning'),
            ...
            'status_update' => [
                ...
                'action_url' => route('client.rendezvous.index'),
